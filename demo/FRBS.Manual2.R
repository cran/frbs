 ...
 ## In this function, we convert crisp value into fuzzy value 
 ## based on the data and parameter of membership function.
 ## The output: a matrix representing degree of membership of the data
 num.varinput <- ncol(num.fvalinput)
 MF <- fuzzifier(newdata, num.varinput, num.fvalinput, varinp.mf)
 
 ## Inference Module:
 ## In this function, we will calculate the confidence factor on antecedent for each rule
 ...
 plotMF(object = list(var.mf = var.mf, range.data = range.data, 
