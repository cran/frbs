...
control <- list(popu.size = 300, persen_cross = 0.6, max.iter = 100, persen_mutant = 0.3, epsilon = 0.05, name="sim-0")
...
print("Comparison MSGFS Vs Real Value on Mackey Glass Data Set")
print(bench)
