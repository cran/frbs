...
control <- list(num.labels = 5, max.iter = 100, step.size = 0.01, alpha.heuristic = 1, name = "MG1000")  
method.type <- "HGD"
...
print("Comparison HGD Vs Real Value on Mackey Glass Data Set")
print(bench)
