...
control <- list(num.labels = 5, popu.size = 10, persen_cross = 0.9, max.iter = 50, persen_mutant = 0.1, type.mf = 3, type.defuz = 1, type.tnorm = 1, type.snorm = 1, classification = FALSE, name="sim-0")
...
print("Comparison GFS Vs Real Value on Gas Furnace Data Set")
print(bench)
